...
<?php get_header(); ?>
  ...
  <section class="partner-hero">
    ...
    <p>Wir möchten uns herzlich bei  unseren zahlreichen Sponsor*innen und Partner*innen bedanken, die das Kunstmue Festival unterstützen.</p>
    </div>
  </section>
  <section class="partner-logo">
    <div class="partner-logo-container">
      
      <img src="<?php echo get_template_directory_uri(); ?>/images/logos/green.jpg" alt="logos">
